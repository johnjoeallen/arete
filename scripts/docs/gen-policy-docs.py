...
for cat in sorted(by_cat):
    lines += [f"## {cat}", ""]
    lines.append("| Rule | Title | Matcher | " + " | ".join(short[p] for p in policy_ids) + " |")
...
lines = [
    ...
    "<!-- Generated by scripts/docs/gen-policy-docs.py — do not edit by hand. -->",
    "",
    "A **policy** is a set of rules. It specifies each rule's score deduction",
    "(or `PROHIBITED`), and may override a rule's default parameters. A policy",
    "can also set a passing score and a grade set. Pick one in the scoring",
    "picker; the first policy listed here is the default when an unknown one is",
    "requested.",
    "",
    "```",
