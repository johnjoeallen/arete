 ...
 * `PathItem`; rule bundles consequently remain independent of the host's
 ...
 * and individual operation; keeping the diagnostics separate is deliberate,
 ...
 *     wanted, should be an explicit host or rule capability.
