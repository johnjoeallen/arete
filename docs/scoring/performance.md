...
- **Cheap enough to ignore.** A scoring runs ~150 matcher evaluations;
...
At 1–11 µs per matcher call and 111 evaluations per scoring, the entire
...
measurable, and it is not where a scoring spends its time.
