 ...
 * return a collection of occurrence maps; it must not calculate a score,
 ...
 *
 * Only depend on fields documented by this detector or the host's stable
 * detector API. Parser-owned Swagger/OpenAPI Java objects are never exposed
 ...
 *
 * The companion Detector.md declares these values and the bundle loader
 ...
 * ------------
 *
 * Each matching operation becomes one occurrence map. `pointer` and `path`
 * let Speculate attach the finding to the endpoint in the Viewer. Multiple
