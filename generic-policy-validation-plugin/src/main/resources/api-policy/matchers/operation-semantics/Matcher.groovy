 ...
 * ============================
 *
 * This rule works solely against the stable rule map:
 *
 *   api.paths[*].path
 ...
 *     Retaining this explicit no-match is safer than inventing a diagnostic.
 *
 * The rule returns diagnostics only. The host policy applies a deduction
