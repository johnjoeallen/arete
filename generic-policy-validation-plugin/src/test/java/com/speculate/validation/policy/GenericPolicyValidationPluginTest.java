...
class GenericPolicyValidationPluginTest {
    ...
    void executesTheStrictGroovyDetectorAndDeductsOnlyOncePerRule() {
        ...
        assertEquals(51, result.getRulesEvaluatedCount());
        ...
        assertEquals(97.0, result.getOverallScore());
        assertEquals(97.0, result.getOverallScoreWithoutBlockers());
    ...
    void returnsAFullScoreWhenNoStrictRuleMatches() {
        ...
        assertEquals(99.0, result.getOverallScore());
    }
