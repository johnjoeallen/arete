...
class GenericPolicyValidationPluginTest {
    ...
    void executesTheBundledGroovyDetectorAndDeductsOnlyOncePerRule() {
        ...
        assertEquals(35, result.getRulesEvaluatedCount());
