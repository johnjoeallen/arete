 ...
 * those findings again instead of an empty picker — scoring is still
 ...
 * run time (independent of {@link net.dublinux.arete.domain.SpecEntity#getContentHash()},
...
public class SpecScoringResultEntity {
