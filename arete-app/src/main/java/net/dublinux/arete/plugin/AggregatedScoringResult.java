 ...
 */
public record AggregatedScoringResult(
        List<ScoringSummary> pluginSummaries,
    ...
    public AggregatedScoringResult(List<ScoringSummary> pluginSummaries, List<AttributedDiagnostic> diagnostics,
